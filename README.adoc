...
Select one of the following deployment guides based on your platform:
  ...
  * link:{docsdir}/Install-AIO-Libvirt.adoc[All-in-One using libvirt]
  * link:{docsdir}/Install-oVirt.adoc[oVirt (Red Hat Virtualization)]
  * link:{docsdir}/Install-Utiliity-Only.adoc[Utility Server Only]
