...
Depending on how quickly you run *oc get pods* after rolling out the new deployment, you may see the ContainerCreating container running and/or the pre-existing deployment of *hello-app-1-????* terminating.  Also note that the 'oc' command has a built in 'watch mode', although I prefer the output refresh of using the actual linux *watch* command.  Either way, just press CTRL-C to exit the `watch` process and return to your shell.
...
[source,indent=4]
----
DETECTERMINED ROUTE: helloworld.cloud.example.com
...
[source,indent=4]
----
DETECTERMINED ROUTE: helloworld2.cloud.example.com
...
cli-hello3  5Gi        RWX            Recycle          Available                                      7s
----
...
[source,indent=4]
----
DETECTERMINED ROUTE: helloworld3.cloud.example.com
...
[source,indent=4]
----
DETECTERMINED ROUTE: helloworld4.cloud.example.com
...
[source,indent=4]
----
DETECTERMINED ROUTE: helloworld5.cloud.example.com
