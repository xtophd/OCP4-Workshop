...
cli-ex01                                           CLI Exercise 01   Active
default                                                              Active
...
You have access to the following projects and can switch between them with ' project <projectname>':
  ...
  * cli-ex01 - CLI Exercise 01
    ...
    openshift-apiserver
...<SNIP>...
Using project "cli-ex01" on server "https://api.ocpdemo.lab.linuxsoup.com:6443".
----
...
Labels:                 kubernetes.io/metadata.name=cli-ex01
                        pod-security.kubernetes.io/audit=restricted
                        pod-security.kubernetes.io/audit-version=latest
                        pod-security.kubernetes.io/warn=restricted
                        pod-security.kubernetes.io/warn-version=latest
Annotations:            openshift.io/description=CLI exercise to deploy hello-world container
                        openshift.io/display-name=CLI Exercise 01
...
Display Name:           CLI Exercise 01
Description:            CLI exercise to deploy hello-world container
Status:                 Active
Node Selector:          <none>
Quota:                  <none>
...
You just instructed Openshift to create a new application called *hello-app*.  Without getting caught up in the details, basically what happens is:
  ...
  * Openshift checks the local catalog for an existing copy of the specified image *ubi8/httpd-24*
...
[source,indent=4]
----
In project CLI Exercise 01 (cli-ex01) on server https://api.ocpdemo.lab.linuxsoup.com:6443

svc/hello-app - 172.30.153.192 ports 8080, 8443
  deployment/hello-app deploys istag/hello-app:latest
    deployment #2 running for 25 seconds - 1 pod
    deployment #1 deployed 26 seconds ago

1 info identified, use 'oc status --suggest' to see details.
NAME        READY   UP-TO-DATE   AVAILABLE   AGE
hello-app   1/1     1            1           26s

NAME                         READY   STATUS    RESTARTS   AGE
hello-app-7f5c668764-9kxpb   1/1     Running   0          25s

NAME        TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)             AGE
hello-app   ClusterIP   172.30.153.192   <none>        8080/TCP,8443/TCP   26s
----
...
Once **hello-app-????** is in a 'Running' state, you can proceed with verification that the POD is operating correctly.  There are a few scripts installed in /usr/local/bin to make these steps a little less error prone.

.[root@master ~]#
----
exercise-validate-service.sh
----
...
hello-app   hello-app-cli-ex01.apps.ocpdemo.lab.linuxsoup.com          hello-app   8080-tcp                 None
----
...
.[root@master ~]#
----
oc describe namespace cli-ex01
----
...
Depending on how quickly you run *oc get pods* after rolling out the new deployment, you may see the ContainerCreating container running and/or the pre-existing deployment of *hello-app-????* terminating.  Also note that the 'oc' command has a built in 'watch mode', although I prefer the refreshed output provided by the linux *watch* command.  Either way, just press CTRL-C to exit either `watch` modes and return to your shell.
...
----
NAME                         READY   STATUS    RESTARTS   AGE
hello-app-7f5c668764-jm5nn   1/1     Running   0          2s
----
...
[source,indent=4]
----
DETERMINED POD = hello-app-7f5c668764-jm5nn
BASH EXEC: oc cp /usr/local/etc/exercise-hello-world.html hello-app-7f5c668764-jm5nn:/var/www/html/index.html

Copying /usr/local/etc/exercise-hello-world.html to hello-app-7f5c668764-jm5nn:/var/www/html/index.html
----
...
## DETERMINED ROUTE: hello-app-cli-ex01.apps.ocpdemo.lab.linuxsoup.com
## EXEC: curl -s hello-app-cli-ex01.apps.ocpdemo.lab.linuxsoup.com
...
.[root@master ~]#
----
exercise2-install-helloworld.sh
----
