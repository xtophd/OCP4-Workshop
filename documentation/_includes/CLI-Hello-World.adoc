...
There is a sample script in /var/tmp you can run to make life a little easier.

.[root@master ~]#
----
/var/tmp/install-helloworld-html.sh
----
...
OR, if you want to do things by hand here are the steps.
