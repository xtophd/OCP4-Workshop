...
NOTE: For consistancy, it should be noted that normal steps to deploying an application (Create Project, Create Application, Expose Route) where all don in the section above.  This exercise only modifies the existing projet.
