...
Now you can use the `Terminal` feature found in the **Pod** Overview page.  From there you can access the shell, poke around and install a helloworld **index.html**.
