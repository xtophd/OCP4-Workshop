...
The last task to complete Solution #1 is to initiate a new deployment.  For that you click on the three vertical dots on the far right of the depolyment configuration, and select `Deploy`
...
====
image::ocp-webui-hello3-storage-pvc.png[Add Storage]
====
