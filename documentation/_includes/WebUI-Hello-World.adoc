...
A sample YAML file is provided on the workstation to make this process easy.  Use the `Browse` button on the search bar to locate the file.  Details in the dialog below.
...
[horizontal]
*Filename*:: /var/tmp/nfs-pv-02.txt
