...
Now you can use the `Terminal` feature found in the **Pod** Overview page.  From there you can access the shell, poke around, and to complete the task install a helloworld index.html.

.sh-4.2$
----
cd /var/www/html
curl helloworld.cloud.example.com >> index.html
-----
