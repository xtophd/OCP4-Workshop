...
You should be returned to the *Project Overview* page as shown.  If you don't see the details, you probably just need to click on *>* to expand the deployment configuration.
