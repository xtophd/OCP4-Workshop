...
====
image::ocp-webui-hello2-project-select.png[Select Project]
====
...
Select the Pod and then use the `Terminal` feature found in the **Pod** Overview page.  From there you can access the shell and install a helloworld **index.html**.
