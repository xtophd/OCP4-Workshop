...
If you are planning to use a NAT'd network, the playbooks will create the network using virsh.  You only need to provide the provide proper info for IP address space.
