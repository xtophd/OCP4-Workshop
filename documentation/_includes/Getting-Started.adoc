...
Now you are ready to proceed with executing the openshift isntallation.  This typically runs for about 30-40 minutes.  
...
If you examine the install script, it breaks the installation into 3 parts: pre-install, install & post-install.
