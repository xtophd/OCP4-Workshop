...
Sample output will be titled with [red]#Obvious# and [big red yellow-background]*"Your output should look like this"* and also be indented to help with visual identification.  Sometimes there will also be footnotes and/or callouts.

.Your output should look like this
[source,indent=4,color=yellow]
++++
<em><pre>
