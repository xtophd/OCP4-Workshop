...
The next step is to select `Deploy`.

====
image::ocp-webui-hw1-03-image-deploy.png[Image Deploy]
====

Click the radio button next to `Image Name`.

====
image::ocp-webui-hw1-04-image-name.png[Image Name]
====

Enter the values as shown below, and then click the `Search` icon.

.Key-Values for Application Configuration
[horizontal]
*Image Name*:: registry.access.redhat.com/rhscl/httpd-24-rhel7

Now you are presented with a description of the specified image.

====
image::ocp-webui-hw1-05-image-name.png[Image Name]
====

Scroll down a bit and change the *Name*.
...
====
image::ocp-webui-hw1-06-resource-name.png[Image Name]
====
